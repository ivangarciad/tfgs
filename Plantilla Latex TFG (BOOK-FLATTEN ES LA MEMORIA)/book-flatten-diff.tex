...
%DIF DEL book-flatten-oldtmp-22578.tex   Fri Jan 30 13:04:35 2015
%DIF ADD book-flatten.tex                Fri Jan 30 13:04:34 2015
...
%DIF 316c316
%DIF < \newcommand{\mybookauthor}{Borja}
%DIF -------
\newcommand{\mybookauthor}{Sergio Martín Gómez} %DIF > 
%DIF -------
...
\label{sec:presentacion}
 ...
 \DIFaddbegin \DIFadd{Estamos metiendo cambios.
}

\DIFaddend Esta plantilla\footnote{Asegúrate de compilar de nuevo el documento
...
\DIFdelbegin \DIFdel{cubrir las necesidades de generación de memorias }%DIFDELCMD < \LaTeX{} %%%
\DIFdel{para cada uno
}\DIFdelend de los TFCs/TFMs/TFGs y tesis doctorales que se generen en la Escuela
